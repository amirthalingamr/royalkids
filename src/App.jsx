...
const courseData = {
  en: [
    ...
    },
    {
      ...
      points: [
        'Beginner-friendly programming logic',
        'Build mini projects and games',
  ...
  ta: [
    ...
    },
    {
      ...
      points: [
        'சில விநாடிகளில் கணக்கிடும் திறன்',
        'எண் புரிதல் வலுப்படும்',
        'கணிதம் மீதான ஆர்வம் கூடும்',
      ],
      icon: '🧠',
    },
    {
      ...
      age: 'வயது 7-16',
      tagline: 'பள்ளி மற்றும் நாளாந்த வாழ்க்கைக்கான டிஜிட்டல் திறன்',
      points: [
        'டைப்பிங், கோப்புகள், இணைய பாதுகாப்பு',
        'படைப்பாற்றல் டிஜிட்டல் செயல்பாடுகள்',
        'கணினி அடித்தள திறன்கள்',
      ],
      icon: '💻',
    },
    {
      ...
      points: [
        'தொடக்க நிலை நிரலாக்கம்',
        'சிறிய திட்டங்கள் மற்றும் கேம்கள்',
        'சிக்கல் தீர்க்கும் திறன் வளர்ச்சி',
      ],
      icon: '⌨️',
    },
  ],
